...
foreach(_expectedTarget PopSift::popsift)
...
# Create imported target PopSift::popsift
add_library(PopSift::popsift SHARED IMPORTED)

set_target_properties(PopSift::popsift PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/;/usr/local/cuda/include;${_IMPORT_PREFIX}/include"
...
file(GLOB CONFIG_FILES "${_DIR}/PopSiftTargets-*.cmake")
